...
// 1. 全域變數
let currentReadingArticleTitle = "";   // 記錄目前正在閱讀的文章標題
let isAutoScrollingToAnalysis = false; // 旗標：是否正在由按鈕觸發滾動
 
// 2. 從 LocalStorage 獲取已讀列表
...
// =======================================================
// === Live2D 貓咪系統 (預設白貓 + 無TTS + 雙重聲效 + 海量題庫) ===
// =======================================================
...
// 輔助函式：將 Blob 轉為 Base64 DataURI (避開 Blob URL 權限問題)
function blobToDataURL(blob) {
	...
	// 3. Live2D 模型載入器 (Base64 內嵌版 - 終極修復)
